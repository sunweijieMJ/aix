...
// 注册应用级文案覆盖切片：业务在 createLocale(locale, { messages: { menu: ... } })
...
export type { MenuLocale } from './types';
export { default as zhCN } from './zh-CN';
export { default as enUS } from './en-US';

/** Menu 组件语言包（供 useLocale 使用） */
export const locale: ComponentLocale<MenuLocale> = {
  'zh-CN': zhCN,
  'en-US': enUS,
};
